...
var text = 0, password = 0, vcode = 0;
	function check(str,a) {
		...
		case 1:
			...
			break;
		case 11:
			document.getElementById("msgtext").innerHTML = "请输入新管理员账号";
			break;
		case 2:
			password = 1;
		...
		case 21:
		case 22:
			document.getElementById("msgpassword").innerHTML = "密码长度6-16位，数字、字母";
			break;
		case 42:
			vcode = 1;
...
<body class = "reg-new">
	<div class = "reg-main">
		<div class = "reg-title">增加管理员账号
		<a href = "admi.jsp"><img align = "right" src = "./images/close.png" id = "close"></a>			
		</div>		
		<form id = "regform" action = "AddAdmi" method = "post" onsubmit = "return change()">
			<div class = "form mt30">
				<input type = "text" id = "newName" name="newName" 
				placeholder="请输入新管理员账号" autocomplete="off" onblur = "check(this.value, 1);" >
				<p class="err">
					<span id = "msgtext">&nbsp;</span>
				</p>
				<input type="password" id="accountPassword" name="accountPassword" 
				autocomplete="off" placeholder="密码长度6-16位，数字、字母" onblur = "check(this.value, 2);">
				<p class="err">
